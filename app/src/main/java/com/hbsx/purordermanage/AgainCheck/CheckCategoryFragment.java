...
import com.hbsx.purordermanage.AgainCheck.adapter.CheckCategoryAdapter;
...
public class CheckCategoryFragment extends Fragment {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case CATEGORY_LIST:
                    ...
                    //利用数据源生成配器
                    adapter = new CheckCategoryAdapter(catelist);
