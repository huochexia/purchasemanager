...
import com.hbsx.purordermanage.InputData.adapter.SelectProviderAdapter;
...
//        getProviderList();
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case USER_REQUEST:
                    ...
                    mAdapter = new SelectProviderAdapter(mProviderList, orderDate);
    ...
    public static void actionStart(Context mContext, String orderDate) {
        Intent intent = new Intent(mContext, SelectProviderActivity.class);
